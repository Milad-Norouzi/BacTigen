...
🚀 How to Run BacTigen
    ...
    Double‑click the BacTigen.lnk shortcut.

    Your default web browser will open automatically at:
    http://127.0.0.1:4338/

    The BacTigen interface will load. You can now upload a FASTA file or paste protein sequences and start the analysis.
